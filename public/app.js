    ...
    document.getElementById('todoForm').addEventListener('submit', async (e) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                document.querySelector('button[type="submit"]').innerHTML = '<i class="fas fa-plus"></i> Add Todo';
                loadTodos();
            }
        } catch (error) {
...
async function editTodo(id, name, description) {
    ...
    document.querySelector('button[type="submit"]').innerHTML = '<i class="fas fa-save"></i> Update Todo';
